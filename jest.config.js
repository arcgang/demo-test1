  ...
  projects: [
    ...
    // globals (Request, Response, Headers) are available via Node 18+.
    {
      ...
      testMatch: [
        ...
        "**/__tests__/sim-esim-catalog-route.test.ts",
        "**/__tests__/validate-configuration-route.test.ts",
      ],
      moduleNameMapper: {
        "^@/(.*)$": "<rootDir>/src/$1",
      },
    ...
    // All other tests (services, seeds, React components) use jsdom.
    {
      ...
      testPathIgnorePatterns: [
        ...
        "sim-esim-catalog-route.test.ts",
        "validate-configuration-route.test.ts",
      ],
      moduleNameMapper: {
        "^@/(.*)$": "<rootDir>/src/$1",
      },
